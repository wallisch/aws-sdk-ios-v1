...
/**
 * Batch Result Error Entry Unmarshaller
 */
@interface SQSBatchResponseErrorEntryUnmarshaller:SQSResponseUnmarshaller {
    SQSBatchResponseErrorEntry *response;
}


@property (nonatomic, readonly) SQSBatchResponseErrorEntry *response;
