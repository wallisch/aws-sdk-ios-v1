...
/**
 * Create Topic Result Unmarshaller
 */
@interface SNSCreateTopicResponseUnmarshaller:SNSResponseUnmarshaller {
    SNSCreateTopicResponse *response;
}


@property (nonatomic, readonly) SNSCreateTopicResponse *response;
