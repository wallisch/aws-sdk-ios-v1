...
/**
 * Get Endpoint Attributes Result Unmarshaller
 */
@interface SNSGetEndpointAttributesResponseUnmarshaller:SNSResponseUnmarshaller {
    SNSGetEndpointAttributesResponse *response;
}


@property (nonatomic, readonly) SNSGetEndpointAttributesResponse *response;
