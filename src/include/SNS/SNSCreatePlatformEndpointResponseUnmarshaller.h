...
/**
 * Create Platform Endpoint Result Unmarshaller
 */
@interface SNSCreatePlatformEndpointResponseUnmarshaller:SNSResponseUnmarshaller {
    SNSCreatePlatformEndpointResponse *response;
}


@property (nonatomic, readonly) SNSCreatePlatformEndpointResponse *response;
