 ...
 * @param theIpPermissions List of IP permissions to revoke on the
 * specified security group. For an IP permission to be removed, it must
 * exactly match one of the IP permissions you specify in this list.
