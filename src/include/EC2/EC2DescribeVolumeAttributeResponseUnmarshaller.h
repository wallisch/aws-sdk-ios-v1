...
/**
 * Describe Volume Attribute Response Unmarshaller
 */
@interface EC2DescribeVolumeAttributeResponseUnmarshaller:EC2ResponseUnmarshaller {
    EC2DescribeVolumeAttributeResponse *response;
}


@property (nonatomic, readonly) EC2DescribeVolumeAttributeResponse *response;
