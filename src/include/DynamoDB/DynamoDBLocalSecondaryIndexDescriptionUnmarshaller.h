...
/**
 * Local Secondary Index Description Unmarshaller
 */
@interface DynamoDBLocalSecondaryIndexDescriptionUnmarshaller:DynamoDBResponseUnmarshaller {
    DynamoDBLocalSecondaryIndexDescription *response;
}
