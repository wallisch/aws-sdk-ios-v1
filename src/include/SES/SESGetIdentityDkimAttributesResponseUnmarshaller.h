...
/**
 * Get Identity Dkim Attributes Result Unmarshaller
 */
@interface SESGetIdentityDkimAttributesResponseUnmarshaller:SESResponseUnmarshaller {
    SESGetIdentityDkimAttributesResponse *response;
}


@property (nonatomic, readonly) SESGetIdentityDkimAttributesResponse *response;
