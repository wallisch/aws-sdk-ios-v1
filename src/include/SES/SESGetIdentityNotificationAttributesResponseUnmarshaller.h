...
/**
 * Get Identity Notification Attributes Result Unmarshaller
 */
@interface SESGetIdentityNotificationAttributesResponseUnmarshaller:SESResponseUnmarshaller {
    SESGetIdentityNotificationAttributesResponse *response;
}


@property (nonatomic, readonly) SESGetIdentityNotificationAttributesResponse *response;
