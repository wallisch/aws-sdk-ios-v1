...
/**
 * Get Identity Verification Attributes Result Unmarshaller
 */
@interface SESGetIdentityVerificationAttributesResponseUnmarshaller:SESResponseUnmarshaller {
    SESGetIdentityVerificationAttributesResponse *response;
}


@property (nonatomic, readonly) SESGetIdentityVerificationAttributesResponse *response;
