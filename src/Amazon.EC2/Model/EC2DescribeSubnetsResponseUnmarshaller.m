...
@implementation EC2DescribeSubnetsResponseUnmarshaller
...
-(void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict
{
    ...
    if ([elementName isEqualToString:@"subnetSet"]) {
        ...
        listUnmarshaller.endListElementName = @"subnetSet";
        listUnmarshaller.entryElementName   = @"item";
        listUnmarshaller.delegateClass      = [EC2SubnetUnmarshaller class];
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([elementName isEqualToString:@"DescribeSubnetsResponse"]) {
        if (caller != nil) {
...
-(EC2DescribeSubnetsResponse *)response
{
    if (nil == response) {
        response = [[EC2DescribeSubnetsResponse alloc] init];
    }
    return response;
}
