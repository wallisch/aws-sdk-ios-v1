...
#import "EC2ImportInstanceVolumeDetailItemUnmarshaller.h"
...
@implementation EC2ImportInstanceVolumeDetailItemUnmarshaller
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([elementName isEqualToString:@"importInstanceVolumeDetailItem"]) {
        if (caller != nil) {
...
-(EC2ImportInstanceVolumeDetailItem *)response
{
    if (nil == response) {
        response = [[EC2ImportInstanceVolumeDetailItem alloc] init];
    }
    return response;
}
