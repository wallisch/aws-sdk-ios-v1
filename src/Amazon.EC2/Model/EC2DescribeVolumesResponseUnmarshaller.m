...
@implementation EC2DescribeVolumesResponseUnmarshaller
...
-(void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict
{
    ...
    if ([elementName isEqualToString:@"volumeSet"]) {
        ...
        listUnmarshaller.endListElementName = @"volumeSet";
        listUnmarshaller.entryElementName   = @"item";
        listUnmarshaller.delegateClass      = [EC2VolumeUnmarshaller class];
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([elementName isEqualToString:@"DescribeVolumesResponse"]) {
        if (caller != nil) {
...
-(EC2DescribeVolumesResponse *)response
{
    if (nil == response) {
        response = [[EC2DescribeVolumesResponse alloc] init];
    }
    return response;
}
