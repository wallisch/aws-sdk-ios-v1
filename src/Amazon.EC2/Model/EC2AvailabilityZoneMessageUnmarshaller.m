...
#import "EC2AvailabilityZoneMessageUnmarshaller.h"
...
@implementation EC2AvailabilityZoneMessageUnmarshaller
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([elementName isEqualToString:@"availabilityZoneMessage"]) {
        if (caller != nil) {
...
{
    if (nil == response) {
        response = [[EC2AvailabilityZoneMessage alloc] init];
    }
    return response;
}
