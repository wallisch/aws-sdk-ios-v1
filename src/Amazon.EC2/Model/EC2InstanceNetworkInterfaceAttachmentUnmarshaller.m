...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([elementName isEqualToString:@"attachmentId"]) {
        self.response.attachmentId = self.currentText;
        return;
    }
    ...
    if ([elementName isEqualToString:@"instanceNetworkInterfaceAttachment"]) {
        if (caller != nil) {
