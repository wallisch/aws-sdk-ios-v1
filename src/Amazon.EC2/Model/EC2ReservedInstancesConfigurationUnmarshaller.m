...
@implementation EC2ReservedInstancesConfigurationUnmarshaller
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([elementName isEqualToString:@"reservedInstancesConfiguration"]) {
        if (caller != nil) {
...
-(EC2ReservedInstancesConfiguration *)response
{
    if (nil == response) {
        response = [[EC2ReservedInstancesConfiguration alloc] init];
    }
    return response;
}
