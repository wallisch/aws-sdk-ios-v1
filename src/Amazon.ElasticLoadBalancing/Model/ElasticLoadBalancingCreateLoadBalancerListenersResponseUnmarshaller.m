...
@implementation ElasticLoadBalancingCreateLoadBalancerListenersResponseUnmarshaller
...
{
    if (nil == response) {
        response = [[ElasticLoadBalancingCreateLoadBalancerListenersResponse alloc] init];
    }
    return response;
}
