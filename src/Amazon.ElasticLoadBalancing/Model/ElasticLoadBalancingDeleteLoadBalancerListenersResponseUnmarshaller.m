...
@implementation ElasticLoadBalancingDeleteLoadBalancerListenersResponseUnmarshaller
...
{
    if (nil == response) {
        response = [[ElasticLoadBalancingDeleteLoadBalancerListenersResponse alloc] init];
    }
    return response;
}
